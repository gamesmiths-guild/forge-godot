...
/// <summary>
/// The context for an <see cref="Overlap3DNode"/>. Holds the entities currently inside, the scratch collections
...
/// </remarks>
public class Overlap3DNodeContext : StateNodeContext
{
	/// <summary>
