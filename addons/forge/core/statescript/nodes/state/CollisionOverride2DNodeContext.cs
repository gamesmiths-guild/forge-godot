...
/// <summary>
/// The context for a <see cref="CollisionOverride2DNode"/>. Holds the body it changed and the bits it found there, so
...
/// </remarks>
public class CollisionOverride2DNodeContext : StateNodeContext
{
	/// <summary>
