...
/// </remarks>
[Tool]
internal sealed partial class Overlap2DNodeEditor : StandardNodeEditorBase
{
	// Input property indexes, matching Overlap2DNode. The entity names whose area to read and so belongs to the
	...
	public override string HandledRuntimeTypeName =>
		"Gamesmiths.Forge.Godot.Core.Statescript.Nodes.State.Overlap2DNode";
	...
	protected override StatescriptResolverResource? GetDefaultInputResolver(int inputIndex)
	{
		...
		// running it. The position and the shape start on an Entity Position 2D and a circle, matching the resolver -
		...
		return inputIndex switch
		{
			...
			PositionInputIndex => new EntityPosition2DResolverResource(),
			ShapeInputIndex => new CircleShape2DResolverResource(),
			_ => null,
		};
	}
