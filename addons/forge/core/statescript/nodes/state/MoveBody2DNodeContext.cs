...
/// <summary>
/// The context for a <see cref="MoveBody2DNode"/>. Holds the move captured at activation so the update loop does not
/// re-resolve its inputs every step.
/// </summary>
/// <remarks>
/// The destination is snapshotted for the same reason Move To 2D snapshots it: travelling to where the target was when
...
/// </remarks>
public class MoveBody2DNodeContext : StateNodeContext
{
	/// <summary>
	/// Gets or sets the body being moved, or <see langword="null"/> when the move could not start.
	/// </summary>
	public PhysicsBody2D? Body { get; set; }
	...
	/// <summary>
	/// Gets or sets how fast the body travels, in pixels per second.
	/// </summary>
