...
/// </summary>
[Tool]
internal sealed partial class LineOfSight3DResolverEditor : NodeEditorProperty
{
	...
	public override string DisplayName => "Line Of Sight 3D";
	...
	public override void Setup(
		...
		bool isArray)
	{
		var resource = property?.Resolver as LineOfSight3DResolverResource;
		...
		// Seeded with Entity Position 3D on both ends: the two points are almost always somebody's position, and a
		...
		_maskPicker.Initialize(
			...
			RaiseLayoutSizeChanged,
			IterationScope,
			maskSpace: CollisionLayerSpace.Physics3D);
		root.AddChild(_maskPicker);
	}

	public override void SaveTo(StatescriptNodeProperty property)
	{
		property.Resolver = new LineOfSight3DResolverResource
		{
