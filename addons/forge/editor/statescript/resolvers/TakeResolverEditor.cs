...
[Tool]
internal sealed partial class TakeResolverEditor : ArrayTransformResolverEditorBase
{
	private NestedResolverPicker? _countPicker;

	public override string DisplayName => "Take";

	public override string ResolverTypeId => "Take";

	public override void SaveTo(StatescriptNodeProperty property)
	{
		property.Resolver = new TakeResolverResource
		{
	...
	protected override void BuildAdditionalRows(
		...
		Action onChanged)
	{
		var existingResource = ExistingResource as TakeResolverResource;
