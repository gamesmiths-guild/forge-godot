...
/// <see cref="CapsuleShape3D.Height"/>, and cannot be less than twice the radius - a capsule shorter than that is a
/// sphere. Rotating it on its side is the query's business, not the shape's.
/// </remarks>
/// <param name="radiusResolver">Resolves the radius.</param>
/// <param name="heightResolver">Resolves the total height.</param>
internal sealed class CapsuleShape3DResolver(
