...
/// </summary>
[Tool]
internal sealed partial class EntityTransformPoint2DResolverEditor : SpatialResolverEditorBase2D
{
	private static readonly Type[] _offsetExpectedTypes = [typeof(NumericsVector2)];

	private NestedResolverPicker? _offsetPicker;
	private CheckBox? _inverseCheckBox;

	public override string DisplayName => "Entity Transform Point 2D";
	...
	public override bool TryGetInlineSummary(out string summary)
	{
		...
		summary = inverse ? "World to Local 2D" : "Local to World 2D";
		return true;
	}
	...
	{
		var resource = existingResource as EntityTransformPoint2DResolverResource;
	...
	{
		return new EntityTransformPoint2DResolverResource
		{
