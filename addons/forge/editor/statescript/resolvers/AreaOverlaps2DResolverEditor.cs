...
/// </summary>
[Tool]
internal sealed partial class AreaOverlaps2DResolverEditor : EntityScopedResolverEditorBase
{
	...
	public override string DisplayName => "Area Overlaps 2D";

	public override string ResolverTypeId => "AreaOverlaps2D";
	...
	public override void Setup(
		...
		bool isArray)
	{
		var existingResource = property?.Resolver as AreaOverlaps2DResolverResource;
		...
		_nodePathField = new LineEdit
		{
			...
			SizeFlagsHorizontal = SizeFlags.ExpandFill,
			TooltipText = "The Area2D to read, as a path from the entity's own node.",
		};
		...
		_includeAreasCheckBox = new CheckBox
		{
			...
			TooltipText = "Count overlapping areas as well as bodies, for entities whose hurtbox is an Area2D.",
		};
	...
	{
		property.Resolver = new AreaOverlaps2DResolverResource
		{
