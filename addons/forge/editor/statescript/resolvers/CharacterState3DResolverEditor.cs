...
/// </summary>
[Tool]
internal sealed partial class CharacterState3DResolverEditor : SpatialResolverEditorBase3D
{
	...
	public override string DisplayName => "Character State 3D";
	...
	{
		int selected = existingResource is CharacterState3DResolverResource resource ? (int)resource.State : 0;
	...
	{
		return new CharacterState3DResolverResource
		{
