...
/// <summary>
/// Base editor for every resolver that produces a query shape.
/// </summary>
/// <remarks>
...
/// </remarks>
internal abstract partial class ShapeResolverEditorBase3D : NodeEditorProperty
{
	...
	protected abstract void BuildShapeRows(VBoxContainer root, ShapeResolverResourceBase3D? existingResource);

	/// <summary>
	/// Creates the resource for this shape with its own operands already applied.
	/// </summary>
	/// <returns>The resource to serialize.</returns>
	protected abstract ShapeResolverResourceBase3D BuildResource();
	...
	{
		return expectedType == typeof(Shape3D);
	}
		...
		bool isArray)
	{
		...
		BuildShapeRows(root, property?.Resolver as ShapeResolverResourceBase3D);
	}
