...
| **Action** | `CancelAbilitiesByTagNode` | [Core Doc](https://github.com/gamesmiths-guild/forge/blob/main/docs/statescript/nodes/action/cancel-abilities-by-tag-node.md) | — | Cancels active abilities on an entity matching the given tags. |
