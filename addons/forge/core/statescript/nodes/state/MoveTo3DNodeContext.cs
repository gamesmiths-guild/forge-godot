...
/// <summary>
/// The context for a <see cref="MoveTo3DNode"/>. Holds the move captured at activation so the update loop does not
...
/// </remarks>
public class MoveTo3DNodeContext : StateNodeContext
{
	/// <summary>
