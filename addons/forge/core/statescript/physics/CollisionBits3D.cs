...
/// restores them.
/// </summary>
internal static class CollisionBits3D
{
	/// <summary>
	...
	public static uint Read(CollisionObject3D body, CollisionBitsTarget target)
	{
	...
	public static void Write(CollisionObject3D body, CollisionBitsTarget target, uint bits)
	{
