...
/// </summary>
[Tool]
internal sealed partial class EntityScale3DResolverEditor : SpatialResolverEditorBase3D
{
	private OptionButton? _spaceDropdown;

	public override string DisplayName => "Entity Scale 3D";
	...
	{
		int selected = existingResource is EntityScale3DResolverResource resource ? (int)resource.Space : 0;
	...
	{
		return new EntityScale3DResolverResource
		{
