...
/// <summary>
/// Resolver resource that reads the first entity of a nested entity array source. Usable anywhere an entity resolver
/// is expected (attributes, tag queries, validity checks).
/// </summary>
[Tool]
[GlobalClass]
public partial class EntityFirstResolverResource : EntityResolverResourceBase
{
	/// <inheritdoc/>
	...
	public override IEntityResolver BuildEntityResolver(Graph graph)
	{
		...
		return new EntityFirstResolver(entityArray!);
	}
}
