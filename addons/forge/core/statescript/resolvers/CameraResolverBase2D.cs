...
/// <summary>
/// Base for every resolver that reads through the 2D camera a graph is looking through.
/// </summary>
/// <remarks>
...
/// </remarks>
internal abstract class CameraResolverBase2D : IPropertyResolver
{
	...
	protected abstract Variant128 ResolveFrom(Node2D contextNode, Camera2D camera, GraphContext graphContext);
...
#pragma warning disable SA1202 // Elements should be ordered by access
	...
	public Variant128 Resolve(GraphContext graphContext)
	{
		...
		Camera2D? camera = contextNode.GetViewport()?.GetCamera2D();
