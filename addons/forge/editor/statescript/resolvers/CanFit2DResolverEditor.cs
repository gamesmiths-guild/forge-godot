...
/// </summary>
[Tool]
internal sealed partial class CanFit2DResolverEditor : SpatialResolverEditorBase2D
{
	private static readonly Type[] _pointExpectedTypes = [typeof(NumericsVector2)];

	private NestedResolverPicker? _destinationPicker;

	public override string DisplayName => "Can Fit 2D";
	...
	{
		var resource = existingResource as CanFit2DResolverResource;
...
#pragma warning restore SA1118 // Parameter should not span multiple lines
	...
	{
		return new CanFit2DResolverResource
		{
