...
[Tool]
[GlobalClass]
public partial class CapsuleShape3DResolverResource : ShapeResolverResourceBase3D
{
	/// <inheritdoc/>
	...
	/// <inheritdoc/>
	protected override string PropertyNamePrefix => "capsuleshape3d";

	/// <inheritdoc/>
	protected override IObjectResolver<Shape3D> CreateResolver(Graph graph)
	{
		return new CapsuleShape3DResolver(BuildDimension(Radius, graph), BuildDimension(Height, graph));
	}
}
