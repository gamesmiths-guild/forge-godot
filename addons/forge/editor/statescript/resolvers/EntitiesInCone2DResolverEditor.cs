...
/// <summary>
/// Resolver editor that reads the entities standing inside a wedge opening from a point.
/// </summary>
[Tool]
internal sealed partial class EntitiesInCone2DResolverEditor : NodeEditorProperty
{
	...
	public override string DisplayName => "Entities In Cone 2D";
	...
	public override void Setup(
		...
		bool isArray)
	{
		var resource = property?.Resolver as EntitiesInCone2DResolverResource;
		...
		// origin, an unseeded direction would be the zero vector, and an unseeded range or angle would be a wedge that
	...
	{
		property.Resolver = new EntitiesInCone2DResolverResource
		{
