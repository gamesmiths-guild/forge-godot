...
/// owner is a <see cref="CollisionObject3D"/> - a <see cref="GridMap"/> owns its shapes itself - so this is the only
/// identity every hit has.</param>
internal readonly record struct RaycastResult3D(
	Vector3 Position,
	Vector3 Normal,
	Node3D? Node,
	IForgeEntity? Entity,
