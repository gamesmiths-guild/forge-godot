...
/// <summary>
/// The context for a <see cref="NavMoveTo2DNode"/>. Holds the agent being steered and, under safe velocity, the
...
/// </remarks>
public class NavMoveTo2DNodeContext : StateNodeContext
{
	/// <summary>
	...
	/// </summary>
	public Vector2 SafeVelocity { get; set; }
