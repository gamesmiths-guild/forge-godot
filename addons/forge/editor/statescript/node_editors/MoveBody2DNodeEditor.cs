...
/// <summary>
/// Node editor for Move Body 2D.
/// </summary>
/// <remarks>
/// The mode setting relabels the value input rather than hiding anything, exactly as Move To 2D's does: the input is
/// read either way and only means seconds or pixels per second depending on the mode, which is what
/// <see cref="StandardNodeEditorBase.GetInputLabel"/> exists for and why the mode is declared as affecting layout.
/// </remarks>
[Tool]
internal sealed partial class MoveBody2DNodeEditor : StandardNodeEditorBase
{
	// Input property index of the duration or speed, matching MoveBody2DNode.
	...
	public override string HandledRuntimeTypeName =>
		"Gamesmiths.Forge.Godot.Core.Statescript.Nodes.State.MoveBody2DNode";
	...
	protected override string? GetInputLabel(int inputIndex)
	{
		...
		return IsDuration ? "Duration (s)" : "Speed (px/s)";
	}
