...
/// </summary>
[Tool]
internal sealed partial class EntitiesAtPoint2DResolverEditor : NodeEditorProperty
{
	...
	public override string DisplayName => "Entities At Point 2D";
	...
	public override void Setup(
		...
		bool isArray)
	{
		var resource = property?.Resolver as EntitiesAtPoint2DResolverResource;
		...
		_includeAreasCheckBox = new CheckBox
		{
			...
			TooltipText = "Count areas as well as bodies, for entities whose hurtbox is an Area2D.",
		};
	...
	{
		property.Resolver = new EntitiesAtPoint2DResolverResource
		{
