...
[Tool]
[GlobalClass]
public partial class AreaOverlaps2DResolverResource : StatescriptResolverResource
{
	/// <inheritdoc/>
	...
	public override void BindInput(Graph graph, ForgeNode runtimeNode, string nodeId, byte index)
	{
		...
		var propertyName = new StringKey($"__areaoverlaps2d_{nodeId}_{index}");
		...
		out IObjectArrayResolver? objectArrayResolver)
	{
		...
		objectArrayResolver = new AreaOverlaps2DResolver(
