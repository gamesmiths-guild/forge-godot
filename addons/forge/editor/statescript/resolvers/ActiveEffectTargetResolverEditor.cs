...
/// <summary>
/// Resolver editor that reads the entity an active effect is applied to.
/// </summary>
[Tool]
internal sealed partial class ActiveEffectTargetResolverEditor : NodeEditorProperty
{
	private Action? _onChanged;
	private NestedResolverPicker? _handlePicker;

	public override string DisplayName => "Active Effect Target";
		...
		bool isArray)
	{
		...
		var existingResource = property?.Resolver as ActiveEffectTargetResolverResource;
	...
	{
		property.Resolver = new ActiveEffectTargetResolverResource
		{
