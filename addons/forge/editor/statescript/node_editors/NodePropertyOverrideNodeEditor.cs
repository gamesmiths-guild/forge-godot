...
/// <summary>
/// Node editor for Node Property Override.
/// </summary>
/// <remarks>
...
/// </remarks>
[Tool]
internal sealed partial class NodePropertyOverrideNodeEditor : StandardNodeEditorBase
{
	...
	[
		...
		new NodeConfigParam(
			...
			DefaultName: "Float",
			AffectsLayout: true,
			RetypesInput: NodePropertyOverrideNode.ValueInput),
		new NodeConfigParam(
			"isArray",
			"Array",
			AffectsLayout: true,
	...
	public override string HandledRuntimeTypeName =>
		"Gamesmiths.Forge.Godot.Core.Statescript.Nodes.State.NodePropertyOverrideNode";
