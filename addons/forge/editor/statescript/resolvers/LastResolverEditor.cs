...
[Tool]
internal sealed partial class LastResolverEditor : ArrayReductionResolverEditorBase
{
	...
	{
		property.Resolver = new LastResolverResource
		{
	...
	{
		return (property?.Resolver as LastResolverResource)?.Source;
	}

	protected override bool GetExistingSourceFolded(StatescriptNodeProperty? property)
	{
		return (property?.Resolver as LastResolverResource)?.SourceFolded ?? true;
	}
