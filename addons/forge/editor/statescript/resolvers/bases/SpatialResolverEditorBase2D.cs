...
/// <summary>
/// Base editor for every resolver that reads something off the 2D node an entity lives on.
/// </summary>
/// <remarks>
...
/// </remarks>
internal abstract partial class SpatialResolverEditorBase2D : EntityScopedResolverEditorBase
{
	...
	protected abstract SpatialResolverResourceBase2D BuildResource();
	...
	public override void Setup(
		...
		bool isArray)
	{
		var existingResource = property?.Resolver as SpatialResolverResourceBase2D;
	...
	{
		SpatialResolverResourceBase2D resource = BuildResource();
	...
	protected virtual void BuildSettingsRows(VBoxContainer root, SpatialResolverResourceBase2D? existingResource)
	{
	}
