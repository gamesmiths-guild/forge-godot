...
[Tool]
internal sealed partial class MinElementResolverEditor : ArrayReductionResolverEditorBase
{
	public override string DisplayName => "Min Element";
	...
	{
		property.Resolver = new MinElementResolverResource
		{
	...
	{
		return (property?.Resolver as MinElementResolverResource)?.Source;
	}

	protected override bool GetExistingSourceFolded(StatescriptNodeProperty? property)
	{
		return (property?.Resolver as MinElementResolverResource)?.SourceFolded ?? true;
	}
