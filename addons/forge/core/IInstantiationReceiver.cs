...
/// <summary>
/// Implemented by an instantiated scene's root to receive the Forge ownership of whatever instantiated it.
/// </summary>
/// <remarks>
...
public interface IInstantiationReceiver
{
	...
	/// when the instantiated scene is a Forge entity in its own right.</param>
