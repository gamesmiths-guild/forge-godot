...
/// <summary>
/// Action node that instantiates a 3D scene into the running game and forgets about it.
/// </summary>
/// <remarks>
/// The instance outlives the node, and the graph, unless something else frees it. That is the point: a projectile
/// should keep flying after the ability that fired it has ended. Use Scene 3D instead for anything whose lifetime
/// should match a state.
/// </remarks>
...
public sealed class InstantiateScene3DNode(
...
{
	/// <inheritdoc/>
	public override string Description => "Instantiates a 3D scene into the running game, without owning its lifetime.";
