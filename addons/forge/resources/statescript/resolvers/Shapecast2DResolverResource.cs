...
[Tool]
[GlobalClass]
public partial class Shapecast2DResolverResource : EntityResolverResourceBase
{
	/// <summary>
	/// How far a sweep reaches when nothing was authored. A nested operand has no unbound state, and a sweep of zero
	/// length never leaves where it started. Larger than the 3D default because a 2D world measures distance in
	/// pixels.
	/// </summary>
	...
	public override IEntityResolver BuildEntityResolver(Graph graph)
	{
		...
		return new Shapecast2DResolver(
	...
	{
		// An unset shape resolves to nothing rather than to a default circle, matching Overlap 2D: a sweep with no
