...
/// <summary>
/// The context for a <see cref="ForceOverride2DNode"/>. Holds the body it captured and what that body's constant force
...
/// one.
/// </remarks>
public class ForceOverride2DNodeContext : StateNodeContext
{
	/// <summary>
