...
/// <summary>
/// The context for a <see cref="LineOfSight3DNode"/>. Remembers whether the line was clear, which is what turns
/// a per-tick check into the transitions the node reports.
/// </summary>
public class LineOfSight3DNodeContext : StateNodeContext
{
	/// <summary>
