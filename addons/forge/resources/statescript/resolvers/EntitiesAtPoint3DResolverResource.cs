...
[Tool]
[GlobalClass]
public partial class EntitiesAtPoint3DResolverResource : StatescriptResolverResource
{
	/// <inheritdoc/>
	...
	public override void BindInput(Graph graph, ForgeNode runtimeNode, string nodeId, byte index)
	{
		...
		var propertyName = new StringKey($"__entitiesatpoint3d_{nodeId}_{index}");
		...
		out IObjectArrayResolver? objectArrayResolver)
	{
		...
		objectArrayResolver = new EntitiesAtPoint3DResolver(
			positionResolver,
