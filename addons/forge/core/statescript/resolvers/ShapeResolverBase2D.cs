...
/// <summary>
/// Base for the resolvers that build a 2D query shape from numbers.
/// </summary>
/// <remarks>
...
/// </remarks>
internal abstract class ShapeResolverBase2D : ObjectResolver<Shape2D>
{
	...
	protected abstract Shape2D CreateShape();
	...
	protected abstract void UpdateShape(Shape2D shape, GraphContext graphContext);

#pragma warning disable SA1202 // Elements should be ordered by access
	public sealed override Shape2D Resolve(GraphContext graphContext)
	{
